...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::middleware(['verified'])->prefix('my-space')->name('my-space.')->group(function () {
        Route::any(
            'users/{user}/read-and-accept-general-terms/{general_term}',
            [
        ...
        */
        Route::middleware('has-accepted-my-space-general-terms-on')->group(function () {
            ...
            Route::get('my-space-general-terms', [MySpaceGeneralTermController::class, 'index'])->name('my-space-general-terms.index');
            Route::get('my-space-general-terms/{my_space_general_term}', [MySpaceGeneralTermController::class, 'show'])->name('my-space-general-terms.show');
