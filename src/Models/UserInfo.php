...
//        'date_of_birth'
    ...
    public static function getFields(): array
    {
        return [
            ...
            'gender_id' => ['select', 'list', 'required', trans('user-infos.Gender'), trans('user-infos.Select the gender'), 'Eutranet\Commons\Models\Gender'],
            'appellative_id' => ['select', 'list', 'required', trans('user-infos.Appellative'), trans('user-infos.Select the title'), 'Eutranet\Commons\Models\Appellative'],
...
//            'resume' => ['input', 'textarea', 'optional', 'Long presentation', 'Presentação longa']
    ...
    public static function saveTranslations()
    {
        $lls = array(
            ...
            array('group' => 'user-infos', 'key' => 'Tax ID', 'text' => '{"en":"Tax ID", "pt":"NIF"}'),
            array('group' => 'user-infos', 'key' => 'Gender', 'text' => '{"en":"Gender", "pt":"Genero"}'),
            array('group' => 'user-infos', 'key' => 'Appellative', 'text' => '{"en":"Appellative", "pt":"Titulo"}'),
            ...
            array('group' => 'user-infos', 'key' => 'Date of Birth', 'text' => '{"en":"Date of birth", "pt":"Data de nascimento"}'),
            array('group' => 'user-infos', 'key' => 'City', 'text' => '{"en":"City", "pt":"Cidade"}'),
            ...
            array('group' => 'user-infos', 'key' => 'Postal code', 'text' => '{"en":"Postal code", "pt":"Codigo postal"}'),
            array('group' => 'user-infos', 'key' => 'Council', 'text' => '{"en":"Council", "pt":"Concelho"}'),
            array('group' => 'user-infos', 'key' => 'District', 'text' => '{"en":"District", "pt":"Distrito"}'),
            array('group' => 'user-infos', 'key' => 'Country', 'text' => '{"en":"Country", "pt":"Pais"}'),
