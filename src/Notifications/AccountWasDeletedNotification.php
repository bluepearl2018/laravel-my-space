...
class AccountWasDeletedNotification extends Notification implements ShouldQueue
{
	use Queueable;
	...
	public function toMail($notifiable): MailMessage
	{
		...
		return (new MailMessage)
			->view('my-space::mails.account-was-deleted', [
	...
	{
		return [
			'title' => __('Your account was deleted.'),
