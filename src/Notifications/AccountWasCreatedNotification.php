...
class AccountWasCreatedNotification extends Notification implements ShouldQueue
{
	use Queueable;
	...
	public function toMail($notifiable): MailMessage
	{
		...
		return (new MailMessage)
			->view('my-space::mails.account-was-created', [
	...
	{
		return [
			'title' => __('Your account was created.'),
