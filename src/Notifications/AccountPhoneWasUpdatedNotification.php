 ...
 */
class AccountPhoneWasUpdatedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage())
            ->view('my-space::mails.account-phone-was-updated', [
    ...
    {
        return [
            'title' => __('Your account phone number was updated.'),
