...
use Eutranet\MySpace\Models\MySpaceUser as User;
...
class UserInfoController extends Controller
{
    ...
    public function create(): View|Factory|Application
    {
        ...
        return view('florbela-backend::user-infos.create', ['aResource' => $aResource, 'bResource' => $bResource]);
    }
...
//			'country_id' => $request->a_or_b === 'a' ? $user->country_id : $request->country_id ?? NULL
        ...
        return redirect()->route('backend.users.user-infos.index', $user);
    }
    ...
    public function show(?User $user, UserInfo $userInfo): Application|Factory|View
    {
        $qcs = [];
        $qcs['nif'] = $user->nif;
        return view('my-space::user-infos.show', [
            'user' => $user,
